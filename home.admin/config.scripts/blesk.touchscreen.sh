#!/bin/bash
# see issue: https://github.com/rootzoll/raspiblesk/issues/646
# and issue: https://github.com/rootzoll/raspiblesk/issues/809
...
if [ $# -eq 0 ] || [ "$1" = "-h" ] || [ "$1" = "-help" ]; then
 ...
 echo "blesk.touchscreen.sh [on|off|calibrate|update]"
 exit 1
fi
...
if [ "$1" = "1" ] || [ "$1" = "on" ]; then
  ...
  /home/admin/python3-env-lnd/bin/pip install /home/admin/raspiblesk/home.admin/BlitzTUI/ 
...
EOF
  ...
  /home/admin/config.scripts/blesk.conf.sh set touchscreen "1"
...
if [ "$1" = "update" ]; then
  ...
  sudo /home/admin/python3-env-lnd/bin/pip install /home/admin/raspiblesk/home.admin/BlitzTUI/
  exit 0
fi
...
if [ "$1" = "0" ] || [ "$1" = "off" ]; then
  ...
  /home/admin/config.scripts/blesk.conf.sh set touchscreen "0"
