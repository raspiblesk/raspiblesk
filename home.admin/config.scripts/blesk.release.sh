...
fullShortCommit=$(git -C /home/admin/raspiblesk rev-parse --short HEAD)
...
# cleaning logs
echo "deleting raspiblesk & system logs .."
...
logger -p info "****** RASPIBLESK RELEASE ******"
echo "OK"

# clean raspiblesk.info toward the values set by sd card build script
echo "cleaning raspiblesk.info"
source /home/admin/raspiblesk.info
echo "baseimage=${baseimage}" > /home/admin/raspiblesk.info
echo "cpu=${cpu}" >> /home/admin/raspiblesk.info
echo "bleskapi=${bleskapi}" >> /home/admin/raspiblesk.info
echo "displayClass=${displayClass}" >> /home/admin/raspiblesk.info

# https://github.com/rootzoll/raspiblesk/issues/1371
echo
...
# https://github.com/raspiblesk/raspiblesk/issues/4469
echo
echo "deleting old API conf ..."
sudo rm /home/bleskapi/blitz_api/.env 2>/dev/null
...
# https://github.com/rootzoll/raspiblesk/issues/1068#issuecomment-599267503
echo
