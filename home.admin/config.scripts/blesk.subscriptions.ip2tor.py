...
sys.path.append('/home/admin/raspiblesk/home.admin/BlitzPy/blitzpy')
from config import RaspiBleskConfig
...
if len(sys.argv) <= 1 or sys.argv[1] == "-h" or sys.argv[1] == "help":
    print("# manage ip2tor subscriptions for raspiblesk")
    print("# blesk.subscriptions.ip2tor.py create-ssh-dialog servicename toraddress torport")
    print("# blesk.subscriptions.ip2tor.py shop-list shopurl")
    print("# blesk.subscriptions.ip2tor.py shop-order shopurl servicename hostid toraddress:port duration "
          "msatsFirst msatsNext [description]")
    print("# blesk.subscriptions.ip2tor.py subscriptions-list")
    print("# blesk.subscriptions.ip2tor.py subscriptions-renew secondsBeforeSuspend")
    print("# blesk.subscriptions.ip2tor.py subscription-cancel id")
    print("# blesk.subscriptions.ip2tor.py subscription-by-service servicename")
    print("# blesk.subscriptions.ip2tor.py ip-by-tor onionaddress")
    sys.exit(1)
...
if Path("/mnt/hdd/app-data/raspiblesk.conf").is_file():
    ...
    ENV = "DEV"
    print("# blesk.ip2tor.py (development env)")
    DEFAULT_SHOPURL = "fulmo7x6yvgz6zs2b2ptduvzwevxmizhq23klkenslt5drxx2physlqd.onion"
    # DEFAULT_SHOPURL = "ip2tor.fulmo.org"
    LND_IP = "192.168.178.95"
    LND_ADMIN_MACAROON_PATH = "/Users/rotzoll/Downloads/RaspiBleskCredentials/admin.macaroon"
    LND_TLS_PATH = "/Users/rotzoll/Downloads/RaspiBleskCredentials/tls.cert"
    SUBSCRIPTIONS_FILE = "/Users/rotzoll/Downloads/RaspiBleskCredentials/subscriptions.toml"
...
forward to your RaspiBlesk TOR address for '{7}':
{4}

You can cancel the subscription anytime under
the "SUBSCRIPTONS" menu on your RaspiBlesk.
...
Message: {1}
    ...
    if subscription['contract_breached']:
        Dialog(dialog="dialog", autowidgetsize=True).msgbox('''
The service was payed & delivered, but RaspiBlesk detected:
{0}
