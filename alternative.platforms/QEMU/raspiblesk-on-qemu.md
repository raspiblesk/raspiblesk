...
11. [Install raspiblesk via build script](https://github.com/rootzoll/raspiblesk/tree/v1.7/alternative.platforms#building-the-raspiblesk-scripts)
12. [Configure signet](https://github.com/rootzoll/raspiblesk/issues/1500#issuecomment-982779830)
13. Reboot with `sudo reboot`.
14. Login with `admin` user.  Default password: `raspiblesk`